      ...
      <div className="flex flex-wrap">
        {pricingOptions.map((option, index) => (
          <div key={index} className="w-full sm:w-1/2 lg:w-1/3 p-2">
            <div className="p-10 border border-neutral-700 rounded-xl">
              <p className="text-4xl mb-8">
                ...
                {index === 1 && (
                  <span
                    className="bg-gradient-to-l from-indigo-300 to-indigo-800 border-0
         text-transparent bg-clip-text text-xl">
              ...
              w-full mt-20 tracking-tight text-xl border border-indigo-600
              rounded-tl-lg py-2 transition duration-300
              hover:bg-indigo-600">
                Subscribe
              </Link>
            </div>
